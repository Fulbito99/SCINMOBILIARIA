  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
        ...
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-[350px] sm:w-[380px] h-[500px] flex flex-col border border-gray-200 mb-4 animate-fade-in-up overflow-hidden">
          ...
          <div className="bg-indigo-600 p-4 flex justify-between items-center text-white">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="font-semibold text-sm">Asistente Conesa</h3>
          ...
          <div className="p-3 bg-white border-t border-gray-100">
            <div className="flex items-center gap-2 bg-gray-100 rounded-full px-4 py-2 border border-transparent focus-within:border-indigo-300 focus-within:bg-white focus-within:ring-2 focus-within:ring-indigo-100 transition-all">
              <input
                type="text"
                value={input}
      ...
      <button
        ...
        className={`bg-indigo-600 hover:bg-indigo-700 text-white p-4 rounded-full shadow-lg transition-transform hover:scale-105 flex items-center justify-center ${isOpen ? 'rotate-90 scale-0 opacity-0 hidden' : 'rotate-0 scale-100 opacity-100'}`}
      >
