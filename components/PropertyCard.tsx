  ...
  return (
    ...
    >
      <div className="relative h-64 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4">
          <p className="text-white text-2xl font-bold">
            {property.currency === 'EUR' ? '€' : '$'} {property.price.toLocaleString()} {property.currency === 'ARS' ? 'ARS' : ''}
          </p>
        </div>
      </div>
      ...
      <div className="p-5">
        ...
        <div className="flex justify-between items-center text-slate-600 border-t border-gray-100 pt-4">
